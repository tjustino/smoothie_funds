...
class TransactionsControllerTest < ActionController::TestCase
  ...
  test "should get edit" do
    test_get_edit   @some_transaction
    assert_response :success
  end

  test "should not get edit - hacker way" do
    test_get_edit        @some_wrong_transaction
    assert_redirected_to dashboard_url
  end

  test "should not get edit - unknow transaction" do
    test_get_edit        @unknow_transaction
    assert_redirected_to dashboard_url
  end
  ...
  test "should update transaction" do
    test_patch_update    @some_transaction
    assert_redirected_to account_transactions_path @some_account
  ...
  test "should not update transaction - hacker way" do
    test_patch_update    @some_wrong_transaction
    assert_redirected_to dashboard_url
  ...
  test "should destroy transaction" do
    assert_difference("Transaction.count", -1) do
      test_delete_destroy  @some_transaction
  ...
  test "should not destroy transaction - hacker way" do
    assert_no_difference "Transaction.count" do
      test_delete_destroy  @some_wrong_transaction
      assert_redirected_to dashboard_url
    end
  end
  ...
  test "should easycheck transaction" do
    test_post_easycheck  @some_transaction
    assert_redirected_to request.env["HTTP_REFERER"]
  ...
  test "should not easycheck transaction - hacker way" do
    test_post_easycheck  @some_wrong_transaction
    assert_redirected_to dashboard_url
  ...
  private ##############################################################################################################
    ...
    def test_post_create(account)
      post :create, params: {
        account_id:  account,
        transaction: test_transaction_attributes(account.categories.sample.id)
      }
    end

    def test_patch_update(transaction)
      @previous_transaction_amount = transaction.amount
      patch :update, params: {
        id:          transaction,
        transaction: test_transaction_attributes(transaction.account.categories.sample)
      }
    end

    def test_transaction_attributes(category)
